...
import 'package:app_car_rental/domain/car.dart';
import 'package:app_car_rental/presentation/components/custom_app_bar.dart';
import 'package:app_car_rental/presentation/providers/cars_list_provider.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:go_router/go_router.dart';
...
// final carRepository = CarRepository();
  ...
  @override
  ConsumerState<CarsScreen> createState() {
    return _CarsScreenState();
  }
}
...
class _CarsScreenState extends ConsumerState<CarsScreen>{
 ...
 void initState() {
  super.initState();
  ref.read(carsNotifierProvider.notifier).getAllCars();
 }
...
class _CarsScreenView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    // List<Car> carsList = ref.watch(carsNotifierProvider);
    final carsList = ref.watch(carsNotifierProvider);
    ...
    floatingActionButton: FloatingActionButton(
      onPressed: () async {
        final newCar = Car (
          ...
          await ref.read(carsNotifierProvider.notifier).addCar(newCar);
      },
